...
//}
//
//func (cat Catalog) Hash() hash.HashSum {
//	hashfunc := md5.New()
//	data := cat.PrimaryKey()
//	io.WriteString(hashfunc, data)
//	hashsum := hashfunc.Sum(nil)
//	return hash.HashSum(fmt.Sprintf("%x", hashsum))
//}
//
//func NewCatalog(musicianId musician.MusicianHash, query MusicianQuery) (archiveGridRecord *Record) {
